...
export default function FinanceLab() {
  const [experienceTarget, setExperienceTarget] = useState<HTMLElement | null>(null);
  ...
  useEffect(() => {
    setExperienceTarget(document.querySelector<HTMLElement>("#experience .wrap"));
  }, []);
  ...
  return (
    <>
      {experienceTarget && createPortal(<ExperienceWorkflows />, experienceTarget)}
